...
public class WeatherStationServer extends Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        component.getDefaultHost().attach(new WeatherStationServer());
        component.start();
    }
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach("/weatherdata", WeatherServerResource.class);
        router.attach("/healthdata", HealthServerResource.class);
        router.attach("/currenthealthdata", CurrentHealthServerResource.class);
        return router;
    }
}
